...
def load_artifacts():
    ...
    rcpt_model = joblib.load(pth('xgb_optuna_rcpt.pkl'))
    params = joblib.load(pth('xgb_optuna_params.pkl'))
...
have_dme = os.path.exists(pth('xgb_optuna_dme.pkl'))
if have_dme:
    dme_model = joblib.load(pth('xgb_optuna_dme.pkl'))
